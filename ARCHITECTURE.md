...
| ルール | 実装 |
|--------|------|
| 全テーブルにtenant_id | マイグレーションでnull: false |
| 全クエリでtenant_id条件 | TenantScoped concernでdefault_scope |
| 管理者でも他社データ閲覧不可 | Current.tenant_idで制御 |
| URLでのデータアクセス防止 | before_actionで所有権チェック |
